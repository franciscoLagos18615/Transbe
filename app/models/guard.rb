class Guard < ApplicationRecord
    ...
    #Ficha de guardia
    has_attached_file :ficha_guardia_doc, styles: { medium: "800x1200#", thumb: "800x1200#" }, default_url: "/images/:style/missing.png"
    validates_attachment_content_type :ficha_guardia_doc, content_type: /\Aimage\/.*\z/
    
    #Certificado de estudios
    has_attached_file :cert_estudio_doc, styles: { medium: "800x1200#", thumb: "800x1200#" }, default_url: "/images/:style/missing.png"
    validates_attachment_content_type :cert_estudio_doc, content_type: /\Aimage\/.*\z/
    
    #Certificado de residencia
    has_attached_file :cert_residencia_doc, styles: { medium: "800x1200#", thumb: "800x1200#" }, default_url: "/images/:style/missing.png"
    validates_attachment_content_type :cert_residencia_doc, content_type: /\Aimage\/.*\z/
    
    #Cedula de identidad
    has_attached_file :cedula_identidad_doc, styles: { medium: "800x1200#", thumb: "800x1200#" }, default_url: "/images/:style/missing.png"
    validates_attachment_content_type :cedula_identidad_doc, content_type: /\Aimage\/.*\z/
    
    #Pacto de horas
    has_attached_file :pacto_horas_doc, styles: { medium: "800x1200#", thumb: "800x1200#" }, default_url: "/images/:style/missing.png"
    validates_attachment_content_type :pacto_horas_doc, content_type: /\Aimage\/.*\z/
    
    #Certificado de antecedentes
    has_attached_file :cert_antecedentes_doc, styles: { medium: "800x1200#", thumb: "800x1200#" }, default_url: "/images/:style/missing.png"
    validates_attachment_content_type :cert_antecedentes_doc, content_type: /\Aimage\/.*\z/
    
    #Credencial
    has_attached_file :credencial_doc, styles: { medium: "800x1200#", thumb: "800x1200#" }, default_url: "/images/:style/missing.png"
